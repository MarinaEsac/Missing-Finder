...
import foundCss from './foundMatchVolunteer.module.css'
import { Link, useNavigate } from 'react-router-dom'
export default function FoundMatchVolunteer() {
                    ...
                    <div className="col-12 text-center">
                        <div className={`${foundCss.layer} d-flex justify-content-center rounded-5`}>
                            <div className=' d-flex flex-column align-items-center'>
                                ...
                                <Link to={"/foundResult"} className={`${foundCss.btnstyle} px-5 mt-3 py-2 rounded-5 text-decoration-none fw-bold text-white`}>Show The Result</Link>
                            </div>
                        </div>
                    </div>
                </div>
